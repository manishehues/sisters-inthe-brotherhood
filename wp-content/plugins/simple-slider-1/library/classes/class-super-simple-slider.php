...
class Super_Simple_Slider {
	...
	public function enqueue_frontend_styles() {
		...
		wp_register_style( $this->_text_domain . '-swiper-bundle', esc_url( $this->assets_url ) . 'css/swiper-bundle.min.css', array(), $this->_version );
		wp_enqueue_style( $this->_text_domain . '-swiper-bundle' );

		// The custom stylesheet
		wp_register_style( $this->_text_domain . '-custom-style', esc_url( $this->assets_url ) . 'css/custom_style.css', array(), $this->_version );
		wp_enqueue_style( $this->_text_domain . '-custom-style' );
	}
	...
	public function enqueue_frontend_scripts() {
		...
		// The swiper slider script file
		wp_register_script( $this->_text_domain . '-swiper-slider-js', esc_url( $this->assets_url ) . 'js/swiper-bundle.min.js');
		wp_enqueue_script( $this->_text_domain . '-swiper-slider-js' );
	}
